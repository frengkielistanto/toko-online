<div class="container-fluid">
        ...
        <div class="carousel-inner">
            ...
            <img src="<?php echo base_url('assets/img/3.svg') ?>" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
            <img src="<?php echo base_url('assets/img/2.svg') ?>" class="d-block w-100" alt="...">
            </div>
        </div>
